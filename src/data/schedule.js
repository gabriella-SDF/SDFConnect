...
export const days = [
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: '2:00 PM', end: '3:00 PM', title: 'Objectives — Breakout Session', tag: 'breakout', location: 'Breakout rooms', description: "Three concurrent breakout sessions — one per objective. You'll head to the group you signed up for." },
      ...
      { time: '6:00 PM', end: '9:00 PM', title: 'Barcade at Golden Gate Taproom', tag: 'social', location: '449 Powell St, San Francisco', description: "We're closing out Day 1 at a nearby Barcade — just an 8-minute walk from the hotel. A great way to unwind and keep the energy going." },
    ],
  },
  {
    id: 'wed',
  ...
  },
  {
    ...
    sessions: [
      { time: '8:00 AM', end: '9:00 AM', title: 'Breakfast', tag: 'meal', location: 'Pavilion' },
      { time: '9:00 AM', end: '12:00 PM', title: 'Team Time', tag: 'team', location: 'Meeting Assignments — see your manager', description: 'Departments break out into team meetings to connect and collaborate.' },
