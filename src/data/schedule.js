...
export const days = [
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: '8:00 AM', end: '9:30 AM', title: 'Breakfast', tag: 'meal', location: 'Pavilion' },
      { time: '8:00 AM', end: '9:30 AM', title: 'Check-in + Swag Pick Up', tag: 'social', location: 'Gold Room Foyer' },
      { time: '9:30 AM', end: '9:45 AM', title: 'House Keeping / GIVE Explanation', tag: 'session', location: 'Gold Room' },
      { time: '9:45 AM', end: '11:45 AM', title: 'AI Hackathon', tag: 'workshop', location: 'Crystal + Fountain Room', description: "We're dedicating a full block to AI. We'll kick things off together in the Gold Room with instructions and context, then break into small cross-functional groups to tackle a real problem together. Check the back of your nametag to see what group you're in." },
