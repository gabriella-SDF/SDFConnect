...
export const days = [
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: '9:30 AM', end: '10:45 AM', title: 'Executive Roundtable', tag: 'discussion', location: 'Gold Room', description: "A candid conversation with leadership covering where we are, where we're placing our bets, and what we're building toward.", speakers: ['Denelle Dixon'] },
      { time: '10:45 AM', end: '11:00 AM', title: 'Break Time', tag: 'break', location: 'Gold Room', description: 'Opportunity to check emails and mingle cross-functionally.' },
  ...
  },
  {
    ...
    sessions: [
      { time: '7:00 AM', end: '8:00 AM', title: 'Morning Activity', tag: 'activity', location: '', description: 'Check your calendar for more details.', optional: true },
      { time: '8:00 AM', end: '9:00 AM', title: 'Breakfast', tag: 'meal', location: 'Pavilion' },
      { time: '8:00 AM', end: '9:00 AM', title: 'Check-in + Swag Pick Up', tag: 'social', location: 'Gold Room Foyer' },
      { time: '9:00 AM', end: '9:15 AM', title: 'House Keeping / GIVE Explanation', tag: 'session', location: 'Gold Room' },
      { time: '9:15 AM', end: '9:45 AM', title: 'AI Panel Discussion', tag: 'discussion', location: 'Gold Room' },
      { time: '9:45 AM', end: '10:00 AM', title: 'Break', tag: 'break', location: '' },
      { time: '10:00 AM', end: '11:45 AM', title: 'AI Hackathon', tag: 'workshop', location: 'Gold Room → Crystal + Fountain', description: "We're dedicating a full block to AI. We'll kick things off together in the Gold Room with instructions and context, then break into small cross-functional groups in Crystal + Fountain to tackle a real problem together. Check the back of your nametag to see what group you're in." },
  ...
  },
  {
    ...
    sessions: [
      { time: '8:00 AM', end: '9:00 AM', title: 'Breakfast', tag: 'meal', location: 'Pavilion' },
      { time: '9:00 AM', end: '12:00 PM', title: 'Team Time', tag: 'team', location: 'Check your Google Calendar', description: 'Departments break out into team meetings. Each team has its own room — check your Google Calendar invite for the exact location.' },
      ...
      { time: '1:30 PM', end: '2:15 PM', title: 'AI Presentations', tag: 'session', location: 'Gold Room', description: 'Winners from the hackathon will be selected using Claude and invited to present their AI problem and solution to the group.' },
      ...
      { time: '3:30 PM', end: '4:00 PM', title: 'Q&A + Wrap-up', tag: 'discussion', location: 'Gold Room' },
...
export const contacts = [
  { name: 'Vivian Bui',     role: 'Primary Onsite Lead', phone: '(916) 600-4181', photo: '/contacts/vivian.jpg' },
  { name: 'Destinee Agard', role: 'Primary Onsite Lead', phone: '(917) 544-5572', photo: '/contacts/destinee.jpg' },
