...
export const days = [
  ...
  },
  {
    ...
    description: "Day 1 is all about setting the pace. Centered around our theme of Accelerate, the day brings together executive presentations, guest speakers, and a deep dive into our objectives — giving the full team the vision, context, and energy to hit the ground running for the retreat and the year ahead.",
    sessions: [
      { time: '8:00 AM', end: '9:00 AM', title: 'Breakfast', tag: 'meal', location: 'Pavilion' },
      { time: '9:00 AM', end: '9:15 AM', title: 'Housekeeping', tag: 'keynote', location: 'Gold Room', description: 'Check-in and swag at Gold Room Foyer. Lisa walks the team through housekeeping — including an overview of the Stellar Scoreboard and how the Swag Store works.', speakers: ['Lisa Macnew'] },
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: '8:00 AM', end: '9:00 AM', title: 'Breakfast', tag: 'meal', location: 'Pavilion' },
      { time: '9:00 AM', end: '9:15 AM', title: 'Housekeeping + Volunteer Explanation', tag: 'keynote', location: 'Gold Room', description: 'Check-in and swag at Gold Room Foyer.' },
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: '2:15 PM', end: '2:30 PM', title: 'Stretch Break', tag: 'break', location: '' },
      { time: '2:30 PM', end: '3:00 PM', title: 'Team Competition Winners', tag: 'social', location: 'Gold Room', description: 'Announcing the Department winner of our team competitions which have been happening over 3 days.' },
      { time: '3:00 PM', end: '3:30 PM', title: 'Stellar Awards', tag: 'social', location: 'Gold Room', description: 'Our traditional Stellar Awards — celebrating the individuals who made it all possible.' },
      { time: '3:30 PM', end: '4:00 PM', title: 'Q&A / Closure', tag: 'keynote', location: 'Gold Room' },
